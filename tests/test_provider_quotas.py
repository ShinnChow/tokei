...
class ProviderQuotaTests(unittest.TestCase):
    ...
    def test_cursor_reads_app_auth_and_maps_usage_summary(self):
        ...
        self.assertEqual(quota["windows"][0]["detail"], "$3.88 / $20.00")
    ...
    def test_cursor_total_spend_uses_percent_when_plan_used_is_allotment(self):
        ...
        self.assertEqual(quota["windows"][0]["detail"], "$5.86 / $70.00")
        self.assertEqual([row["used_pct"] for row in quota["windows"]], [8.365737, 7.173333, 24.0])
